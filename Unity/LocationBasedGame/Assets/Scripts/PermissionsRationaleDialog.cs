...
public class PermissionsRationaleDialog : MonoBehaviour
{
    ...
    {
        GUI.Label(new Rect(10, 20, kDialogWidth - 20, kDialogHeight - 50), "Konumunu Kullanmama izin ver");
        GUI.Button(new Rect(10, kDialogHeight - 30, 100, 20), "Evet");
        if (GUI.Button(new Rect(kDialogWidth - 110, kDialogHeight - 30, 100, 20), "Hayır"))
        {
#if PLATFORM_ANDROID
