...
public class TileManager : MonoBehaviour
{
    ...
    public IEnumerator loadTiles(int zoom)
    {
        ...
        //string url = String.Format("https://api.mapbox.com/styles/v1/mapbox/{5}/static/{0},{1},{2},0,0/{3}x{3}@2x?access_token={4}", lon, lat, zoom, size, key, style);
        ////"https://api.mapbox.com/v4/mapbox.{5}/{0},{1},{2}/{3}x{3}@2x.png?access token={4}"
        //WWW www = new WWW(url);
        //yield return www;
    ...
    void Update()
    {
        ...
        //target.position = Vector3.Lerp(target.position, new Vector3(0, 0f, 0), 2.0f * Time.deltaTime);
